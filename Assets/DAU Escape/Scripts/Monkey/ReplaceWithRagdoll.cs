...
namespace DAUEscape
{
    public class ReplaceWithRagdoll : MonoBehaviour
    {
        ...
        public void Replace()
        {
            ...
            // for each child of the monkey game object (and all the children's children) copy over its positions and rotations
            // e.g. monkey_Eyes_mesh, monkey_Main_ctrl, etc.
            // so the ragdoll will spawn in in the same position and rotation as the monkey in the dead position
