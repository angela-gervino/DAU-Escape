...
The current version of the game includes a pirate player and a monkey enemy. The player cannot take damage or be killed, but the monkey can be damaged and killed by the player. To beat this version of the game the player must defeat the monkey.
